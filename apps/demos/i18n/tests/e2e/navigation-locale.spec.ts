...
test.describe('Navigation Locale Prefix Tests', () => {
  test('navigation links include locale prefix on German blog index page', async ({
    page,
  }) => {
  ...
  test('navigation links include locale prefix on English blog index page', async ({
    page,
  }) => {
