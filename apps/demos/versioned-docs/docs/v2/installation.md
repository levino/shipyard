...
description: How to install and set up the project using version 2.0
sidebar_position: 1
---
...
1. Configure your project - see [Configuration](/docs/v2/configuration)
2. If upgrading from v1, see [Migration Guide](/docs/v2/migration)
