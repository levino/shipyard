...
:::caution Deprecated
This guide is for v1. See the [v2 configuration guide](/docs/configuration) for current options.
:::
...
These features are available in [v2](/docs/configuration).
...
See the [Migration Guide](/docs/migration) for complete instructions.
