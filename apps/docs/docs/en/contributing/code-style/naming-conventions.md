...
Good function names eliminate the need for comments. See [Documentation Through Code](/en/docs/contributing/code-style/documentation-through-code) for more details.
