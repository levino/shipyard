...
- **Starlight started the same way** – [Chris Swithinbank](https://github.com/delucis) built it as a solo project before being hired by Astro
...
- **Open an issue** – Report bugs or request features on [GitHub](https://github.com/levino/shipyard/issues)
