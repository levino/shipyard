...
- **[Docusaurus](https://docusaurus.io/)** – If you need versioned docs, an extensive plugin ecosystem, and don't need custom content types. Good choice if long-term corporate backing matters to you.
- **[Starlight](https://starlight.astro.build/)** – If you only need documentation and want tight Astro integration with minimal configuration.
- **[Plain Astro](https://astro.build/)** – If you want complete control and don't mind building everything from scratch.
