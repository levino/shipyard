...
- [x] Category metadata via `index.md` frontmatter (`sidebar_label`, `sidebar_position`, `collapsed`, `collapsible`, `sidebar_class_name`, `sidebar_custom_props`)
- [x] Custom category icons (via `sidebar_custom_props` in index.md frontmatter)
