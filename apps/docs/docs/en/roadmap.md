...
- [x] `sidebar.label` - Custom sidebar label
- [x] `sidebar.position` - Position in sidebar
- [x] `sidebar.className` - Custom CSS class for sidebar item
- [x] `sidebar.customProps` - Custom properties for sidebar item
...
- [x] `parse_number_prefixes` - Parse number prefixes from filenames (N/A - use `sidebar.position` frontmatter instead)
...
- [x] Category metadata via `index.md` frontmatter (`sidebar.label`, `sidebar.position`, `collapsed`, `collapsible`, `sidebar.className`, `sidebar.customProps`)
- [x] Custom category icons (via `sidebar.customProps` in index.md frontmatter)
...
- [x] `sidebar.label` - Custom label for blog sidebar
