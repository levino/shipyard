...
Check out the [Getting Started guide](/de/docs/getting-started) for full setup instructions.

## What's Next

shipyard is production-ready and actively developed. See the [roadmap](/de/docs/roadmap) for upcoming features.
