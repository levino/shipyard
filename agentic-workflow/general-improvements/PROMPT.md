# Agentic Workflow Session: General Improvements
...
- `agentic-workflow/general-improvements/tasks.json` - Current task list
- `agentic-workflow/general-improvements/history.md` - Recent session history
- `agentic-workflow/general-improvements/learnings.md` - Permanent knowledge base
...
- Update task status in `agentic-workflow/general-improvements/tasks.json`:
...
- Append session summary to `agentic-workflow/general-improvements/history.md` including:
  - What was done
  - **Tips for the next developer** - gotchas, things to watch out for, context that would help
  - Any decisions made and why
- Update `agentic-workflow/general-improvements/learnings.md` if you discovered something permanently useful:
