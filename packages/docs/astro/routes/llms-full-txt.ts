/**
 * Pre-shipped API route for llms-full.txt generation.
 * This file is injected with a static pattern like /docs/llms-full.txt
...
import { generateLlmsFullTxt } from '../../src/llmsTxt'
...
function extractRouteBasePath(url: URL): string {
  ...
  // Remove 'llms-full.txt' from the end
  pathParts.pop()
